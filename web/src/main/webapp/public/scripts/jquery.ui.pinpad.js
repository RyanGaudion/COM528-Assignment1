( function( factory ) {
    ...
    $.widget( "ui.pinpad", {
        ...
        _create: function() {
            ...
            inst.element.attr( "role", "textbox" );
        ...
        _drawKeys: function() {
            ...
            for ( i = 0; i < keys.length; i++ ) {
                ...
                for ( j = 0; j < keys[ i ].length; j++ ) {
                    ...
                    if ( !isNaN( digit ) ) {
                        $( "<button type='button' title='" + digit + "' class='ui-pinpad-key ui-pinpad-key-num-pad-" +
                        ...
                        if ( /^\{\S+\}$/.test( keyId ) ) {
                            ...
                            if ( keyId === "dec" ) {
                                $( "<button type='button' title='" + keyId + "' class='ui-pinpad-key ui-pinpad-key-num-pad-dec' " +
        ...
        _drawCommands: function() {
            ...
            for ( i = 0; i < count; i++ ) {
                ...
                button = $( "<button class='ui-pinpad-command' title='cmd' type='button'>&nbsp;</button>" )
                    .appendTo( col ).button();
            }
